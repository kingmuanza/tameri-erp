...
exports.create = (item) => {
    var items = [];
    var itemsString = localStorage.getItem('saleline');
    if (itemsString) {
        items = JSON.parse(itemsString);
    }
    items.push(item);
    localStorage.setItem('saleline', JSON.stringify(items));
}
...
exports.modify = (item) => {
    ...
    localStorage.setItem('saleline', JSON.stringify(nouveauxitems));
}
