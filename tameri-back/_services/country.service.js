...
exports.create = (item) => {
    var items = [];
    var itemsString = localStorage.getItem('country');
    if (itemsString) {
        items = JSON.parse(itemsString);
    }
    items.push(item);
    localStorage.setItem('country', JSON.stringify(items));
}
...
exports.modify = (item) => {
    ...
    localStorage.setItem('country', JSON.stringify(nouveauxitems));
}
