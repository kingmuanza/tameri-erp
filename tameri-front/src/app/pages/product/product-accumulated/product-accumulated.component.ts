...
@Component({
  selector: 'app-product-accumulated',
  templateUrl: './product-accumulated.component.html',
  styleUrls: ['./product-accumulated.component.scss']
})
export class ProductAccumulatedComponent implements OnInit {
  ...
  getProductItemsValidated(product: Product) {
    const productitems = this.productitems.filter((d) => {
